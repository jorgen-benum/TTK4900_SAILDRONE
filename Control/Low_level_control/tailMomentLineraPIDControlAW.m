function [tau_tail, dot_integrator_z, integrator_z] = tailMomentLineraPIDControlAW(z_d,z, zdot, integrator_z, roll_pitch_yaw)
...
tau_tail = (f_gff + tau_z)/(cos(phi)*cos(theta))
