function [tau_lift_and_drag, alpha, F_lift, F_drag] = liftDragForces(nu_linkAC, vel_flow, foil_span, foil_chord, rho)
...
%     implement input for e_Oswald and parasitic drag
    ...
    S = foil_span*foil_chord;
    AR = (foil_span^2)/S; % can also use foil_heigth/foil_legth for rectangle
